...
KittiOdometrySample::KittiOdometrySample(float128 time,const std::shared_ptr<StereoSequence>ss,
...
KittiOdometrySample::KittiOdometrySample(std::vector<cv::Mat1w> images,
                    cv::Mat1f disparity_,
                    int frame_id_, double time_,const std::shared_ptr<StereoSequence>ss):
